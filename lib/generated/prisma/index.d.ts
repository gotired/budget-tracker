...
export namespace Prisma {
  ...
  */
  ...
  export type TransactionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"is" | "createdAt" | "updateAt" | "amount" | "description" | "date" | "userId" | "type" | "category" | "categoryIcon", ExtArgs["result"]["transaction"]>
  ...
  export interface TransactionDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `is`
     * const transactionWithIsOnly = await prisma.transaction.findMany({ select: { is: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Transactions and only return the `is`
     * const transactionWithIsOnly = await prisma.transaction.createManyAndReturn({
     *   select: { is: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Transactions and only return the `is`
     * const transactionWithIsOnly = await prisma.transaction.updateManyAndReturn({
     *   select: { is: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface TransactionFieldRefs {
    readonly is: FieldRef<"Transaction", 'String'>
  ...
  export type TransactionWhereInput = {
    ...
    is?: StringFilter<"Transaction"> | string
  ...
  export type TransactionScalarWhereWithAggregatesInput = {
    ...
    is?: StringWithAggregatesFilter<"Transaction"> | string
  ...
  export type TransactionUpdateInput = {
    is?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
